...
class SOLE:
    def __init__(self, env, gamma, limit=20):
        ...
        # Save
        self.env, self.n_states, self.n_actions, self.n_state_actions, self.msa, self.R, self.P, self.Q, self.PI, self.PI_changes, self.Q_changes, self.PI_dt, self.Q_dt = env, n_states, n_actions, n_state_actions, msa, R, P, Q, PI, PI_changes, Q_changes, PI_dt, Q_dt
    ...
    def stats(self, title):
        Q_changes, PI_changes, PI_dt, Q_dt = self.Q_changes, self.PI_changes, self.PI_dt, self.Q_dt
